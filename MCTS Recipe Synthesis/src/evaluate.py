...
datasetDict =  {
    'set1' : ["new_train.csv","res_train.csv"],
...
def main():
    ...
    if IS_STATS_AVAILABLE:
        with open(osp.join(ROOT_DIR,'synthesisStatistics18.pickle'), 'rb') as f:
    ...
    print("\nTraining loss per sample:{}".format(trainMSE))
    print("\nTest loss per sample:{}".format(testMSE))
